...
local function pre_process(msg)
	...
	if expiretime then    
		...
		rem_mutes(msg.to.id)
		superrem2(msg)
		return send_large_msg(get_receiver(msg), '<i>✨تاریخ انقضای گروه به پایان رسید برای تمدید به ایدی @LATINO10 پیام بدید✨')
		else
			return
		end
	end
